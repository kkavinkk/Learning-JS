...
console.log(users.find(user => user.id === comments[0].userId)?.firstName + ' ' + users.find(user => user.id === comments[0].userId)?.lastName);


// 3) Which user commented 'OK great thanks'?
console.log(users.find(user => user.id === comments.find(comment => comment.text === 'OK great thanks')?.userId)?.firstName + ' ' 
    + users.find(user => user.id === comments.find(comment => comment.text === 'OK great thanks')?.userId)?.lastName);
